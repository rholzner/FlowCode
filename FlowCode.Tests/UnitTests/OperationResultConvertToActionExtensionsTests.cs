...
public class OperationResultConvertToActionExtensionsTests
{
    ...
    [Fact]
    public void Value_ToAction_Returns_OkObjectResult_When_OperationResult_Is_Successful()
    {
        // Arrange
    ...
    [Fact]
    public void Value_ToAction_Returns_BadRequestObjectResult_With_Exception_Message_When_OperationResult_Is_Not_Successful_And_Exception_Is_Null()
    {
        // Arrange
        var text = "test";
        ValueOperationResult operationResult = new Exception(text);
    ...
    [Fact]
    public void Value_ToAction_Returns_BadRequestObjectResult_With_Exception_Message_When_OperationResult_Is_Not_Successful_And_Exception_Is_Not_Null()
    {
        // Arrange
        var exceptionMessage = "Test Exception";
        var operationResult = new ValueOperationResult(new OperationResultException(exceptionMessage));
    ...
    [Fact]
    public void Value_ToAction_With_Success_Function_Returns_BadRequestResult_When_OperationResult_Is_Not_Successful_And_Exception_Is_Null()
    {
        // Arrange
        ValueOperationResult operationResult = new Exception();
    ...
    [Fact]
    public void Value_ToAction_With_Success_Function_Returns_BadRequestObjectResult_With_Exception_Message_When_OperationResult_Is_Not_Successful_And_Exception_Is_Not_Null()
    {
        // Arrange
        var exceptionMessage = "Test Exception";
        var operationResult = new ValueOperationResult(new OperationResultException(exceptionMessage));
    ...
    [Fact]
    public void Value_ToAction_With_Error_Function_Returns_OkObjectResult_When_OperationResult_Is_Successful()
    {
        // Arrange
        var operationResult = new ValueOperationResult();
    ...
    [Fact]
    public void Value_ToAction_With_Error_Function_Returns_Error_Function_Result_When_OperationResult_Is_Not_Successful_And_Exception_Is_Null()
    {
        // Arrange
        ValueOperationResult operationResult = new Exception();
    ...
    [Fact]
    public void Value_ToAction_With_Error_Function_Returns_Error_Function_Result_When_OperationResult_Is_Not_Successful_And_Exception_Is_Not_Null()
    {
        // Arrange
        var exceptionMessage = "Test Exception";
        var operationResult = new ValueOperationResult(new OperationResultException(exceptionMessage));
    ...
    [Fact]
    public void Value_ToAction_With_Success_And_Error_Functions_Returns_Success_Function_Result_When_OperationResult_Is_Successful_And_Data_Is_Not_Null()
    {
        // Arrange
        var operationResult = new ValueOperationResult<string>("Success");
        var expectedResult = new OkObjectResult("Success");
    ...
    [Fact]
    public void Value_ToAction_With_Success_And_Error_Functions_Returns_BadRequestObjectResult_With_Exception_Message_When_OperationResult_Is_Successful_And_Data_Is_Null()
    {
        // Arrange
    ...
    [Fact]
    public void Value_ToAction_With_Success_And_Error_Functions_Returns_BadRequestObjectResult_With_Exception_Message_When_OperationResult_Is_Not_Successful_And_Exception_Is_Null()
    {
        // Arrange
        var operationResult = new ValueOperationResult<string>("Success");
    ...
    [Fact]
    public void Value_ToAction_With_Success_And_Error_Functions_Returns_Error_Function_Result_When_OperationResult_Is_Not_Successful_And_Exception_Is_Not_Null()
    {
        // Arrange
        var exceptionMessage = "Test Exception";
        var operationResult = new ValueOperationResult<string>(new OperationResultException(exceptionMessage));
        var expectedResult = new BadRequestObjectResult(exceptionMessage);
    ...
    [Fact]
    public void Value_ToAction_With_Success_And_Error_Functions_Returns_Success_Function_Result_When_OperationResult_Is_Successful_And_Data_Is_Not_Null_Using_IActionResult()
    {
        // Arrange
        var operationResult = new ValueOperationResult<string>("Success");
        var expectedResult = new OkObjectResult("Success");
    ...
    [Fact]
    public void Value_ToAction_With_Success_And_Error_Functions_Returns_BadRequestObjectResult_With_Exception_Message_When_OperationResult_Is_Successful_And_Data_Is_Null_Using_IActionResult()
    {
        // Arrange
        var operationResult = new ValueOperationResult<string>();
        var expectedResult = new BadRequestObjectResult("Data is null");
    ...
    [Fact]
    public void Value_ToAction_With_Success_And_Error_Functions_Returns_BadRequestObjectResult_With_Exception_Message_When_OperationResult_Is_Not_Successful_And_Exception_Is_Null_Using_IActionResult()
    {
        // Arrange
        var operationResult = new ValueOperationResult<string>("Success");
    ...
    [Fact]
    public void Value_ToAction_With_Success_And_Error_Functions_Returns_Error_Function_Result_When_OperationResult_Is_Not_Successful_And_Exception_Is_Not_Null_Using_IActionResult()
    {
        // Arrange
        var exceptionMessage = "Test Exception";
        var operationResult = new ValueOperationResult<string>(new OperationResultException(exceptionMessage));
